...
# NB201 : python -i inference/inference.py --pretrained_path model/nasbench201_model_best.pth.tar --train_data data/nasbench201/train_data.pt --valid_data data/nasbench201/test_data.pt --dataset nasbench201 --n_vocab 7
...
def inference(config):
    ...
    if config.dataset.split("_")[0]=='nds':
        ...
        torch.save(pretrained_embeddings, 'cate_' + config.dataset + "_" + config.task + '.pt')
    else:
