...
sample_tests = {x: [0.2, 0.8, 1] for x in sample_tests.keys()}
...
def get_dataloader(args, embedding_gen, space, sample_count, representation, mode, train_indexes=None, test_size=None, pred_mode='pretrain'):
    representations = []
    accs = []
...
for sample_count in sample_counts:
    ...
    test_dataloader, test_indexes = get_dataloader(args, embedding_gen, space, sample_count=None, representation=representation, mode='test', train_indexes=train_indexes, test_size=args.test_size, pred_mode='pretrain')
