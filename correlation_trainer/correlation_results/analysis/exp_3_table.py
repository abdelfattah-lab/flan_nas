...
# Directory
dir_table3 = "correlation_results/table3"
...
# Load CSVs
exp1_dfs = load_csvs_from_directory(dir_table3)
...
final_df = df.pivot_table(index=['space', 'key'], columns='Samples', values='kdt_with_std', aggfunc='first')
